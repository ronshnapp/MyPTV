...
setup(
    name='myptv',
    packages=find_packages(include=['myptv', 'myptv.fibers', 'myptv.TsaiModel', 'myptv.extendedZolof', 'myptv.checkerboard', 'myptv.makePlots', 'myptv.sheets', 'myptv.data_analysis']),
    version='1.3.13',
